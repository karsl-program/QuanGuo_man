...
int main() {
	...
	cout << "--------------------全国人民坑钱大赛（3.2）--------------------" << endl;
	cout<<endl<<"***************************help(帮助)***************************"<<endl;
	cout<<"相较于3.1版本："<<endl; 
	cout<<"1.修复慈善基金会捐钱负数的漏洞"<<endl;
	cout<<"2.更新关卡模式的第二关"<<endl;
	cout<<"3.修复“坑别人的钱”小于0的漏洞"<<endl;
	cout<<"4.修复结束游戏无换行显示的问题"<<endl;
	cout<<"5.优化游戏代码，简化游戏，优化内存"<<endl;
	cout<<"6.修复关卡模式下，商店买等级负数的漏洞"<<endl;
	cout<<"7.简化帮助模块"<<endl;
	cout<<"8.修复彩票的漏洞"<<endl;
	cout<<"9.删去买彩票等级增加的功能"<<endl;
	cout<<"10.增加一点点买彩票的钱"<<endl;
	cout<<"11.增加坑钱大赛的风格，别想用彩票赚钱"<<endl;
	cout<<"12.更新了回血和饥饿等机制"<<endl; 
	cout<<"13.更新了关卡模式的简介等"<<endl; 
	cout<<"14.更新开发者模式特权"<<endl;
	cout<<"15.更新关卡模式第一关功能，修复第一关的漏洞"<<endl;
	cout<<"16.修改一些关卡模式第一关的名词"<<endl;
	cout<<"17.更新在战斗中死亡为概率事件"<<endl;
	cout<<"18.修复死亡时现实原因事件为0的问题"<<endl;
	cout << "\n请登录：";
	cin >> id;
	if (id=="ZJL"||id=="CXK") {
		money=10000000000;
