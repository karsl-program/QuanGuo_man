...
int main() {
	...
	cout << "---------------全国人民坑钱大赛（基于3.1版本的bug大修复）---------------" << endl;
	cout<<endl<<"***************************help(帮助)***************************"<<endl;
	cout<<"相较于3.1版本："<<endl; 
	cout<<"1.修复慈善基金会捐钱负数的漏洞"<<endl;
	cout<<"2.修复“坑别人的钱”小于0的漏洞"<<endl;
	cout<<"3.修复结束游戏无换行显示的问题"<<endl;
	cout<<"4.优化游戏代码，简化游戏，优化内存"<<endl;
	cout<<"5.修复关卡模式下，商店买等级负数的漏洞"<<endl;
	cout<<"6.简化帮助模块"<<endl;
	cout<<"7.修复彩票的漏洞"<<endl;
	cout<<"8.删去买彩票等级增加的功能"<<endl;
	cout<<"9.修复了回血和饥饿等机制"<<endl; 
	cout<<"10.优化开发者模式特权"<<endl;
	cout<<"11.修复第一关的漏洞"<<endl;
	cout<<"12.修改一些关卡模式第一关的名词"<<endl;
	cout<<"13.修复在战斗中死亡为概率事件的漏洞"<<endl;
	cout<<"14.修复死亡时显示原因时间为0的问题"<<endl;
	cout << "\n请登录：";
	cin >> id;
	if (id=="ZJL"||id=="CXK") {
		money=10000000000;
	...
	bool running = true;
	cout<<"1/6   关卡"<<endl;
	cout<<"第一关：森林（经验最低要求：300）"<<endl<<"场景简介：这里有很多资源，但是你要扮演一个原始人，也有一些野兽。小心！！！"<<endl;
