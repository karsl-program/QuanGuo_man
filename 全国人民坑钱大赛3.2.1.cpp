...
int main() {
	...
	cout << "--------------------全国人民坑钱大赛（3.2.1）--------------------" << endl;
	cout<<endl<<"***************************help(帮助)***************************"<<endl;
	cout<<"相较于3.2.0版本："<<endl; 
	cout<<"1.修复关卡模式下第二关狮子追捕100%死亡的问题"<<endl;
	cout<<"2.修复更换钱币单位不存在的漏洞"<<endl;
	cout<<"3.更换32位TDM-GCC 4.8.1内核，缩小游戏占用空间，兼容32位"<<endl;
	cout << "\n请登录：";
	cin >> id;
	if (id=="ZJL"||id=="CXK") {
		money=10000000000;
